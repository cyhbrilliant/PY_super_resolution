...
BNtrain=False
Scale=4
testimg_Data=mp.imread('1.jpg')
# testimg_Label=mp.imread('butterfly_GT.bmp')
# testimg_Label=mp.imread('lenna.bmp')
testimg_Label=cv2.resize(testimg_Data,dsize=(int(testimg_Data.shape[1]*Scale),int(testimg_Data.shape[0]*Scale)))
# testimg_Data=cv2.resize(testimg_Label,dsize=(int(testimg_Label.shape[0]/Scale),int(testimg_Label.shape[1]/Scale)))
