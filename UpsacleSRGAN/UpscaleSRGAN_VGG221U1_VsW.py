...
loss_LSRsm=loss_G+0.003*loss_content
...
# saver.restore(sess,'UpscaleSRGAN_session/SRGAN_MSE_imagenet_area.ckpt')
...
for iter in range(200000):
    ...
    errLSR, resultLSR = sess.run([loss_G, TrainStep_G], feed_dict={Xp: Data_batch/127.5-1., Yp: Label_batch/127.5-1.,train_mode:False})
    ...
    if (iter+1)%500==0:
        ...
        path = saver.save(sess,'UpscaleSRGAN_session/SRGAN_VGG22_imagenet_BGDx30_area_VsW.ckpt')
