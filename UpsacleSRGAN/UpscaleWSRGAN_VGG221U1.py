...
loss_LSRsm=loss_G+0.000008*loss_content
...
saver.restore(sess,'UpscaleSRGAN_session/WSRGAN_VGG22_imagenet_BGDx0.000008_area.ckpt')
...
for iter in range(200000):
    ...
    if (iter+1)%500==0:
        ...
        # path = saver.save(sess,'UpscaleSRGAN_session/SRGAN_VGG22_imagenet_BGDx10_area.ckpt')#50
        # path = saver.save(sess,'UpscaleSRGAN_session/SRGAN_VGG22_imagenet_BGDx30_area.ckpt')
        # path = saver.save(sess,'UpscaleSRGAN_session/WSRGAN_VGG22_imagenet_BGDx30_area.ckpt')#0.00005
        # path = saver.save(sess,'UpscaleSRGAN_session/WSRGAN_VGG22_imagenet_BGDx0.00002_area.ckpt')#0.00002
        path = saver.save(sess,'UpscaleSRGAN_session/WSRGAN_VGG22_imagenet_BGDx0.000008_area.ckpt')#0.000008
        # path = saver.save(sess,'UpscaleSRGAN_session/WSRGAN_MSE_imagenet_area.ckpt')
