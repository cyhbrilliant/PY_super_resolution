...
saver.restore(sess,'UpscaleSRGAN_session/OM25500.ckpt')
...
for iter in range(1000000):
    ...
    if (iter+1)%1500==0:
        ...
        # path = saver.save(sess,'UpscaleSRGAN_session/OM'+str(iter+1)+'.ckpt')
        path = saver.save(sess,'UpscaleSRGAN_session/OMX.ckpt')
