...
# saver.restore(sess,'UpscaleSRGAN_session/SRGAN_MSE_imagenet_Full6.ckpt')
...
for iter in range(200000):
    ...
    errLSR, resultLSR = sess.run([loss_G, TrainStep_LSRsm], feed_dict={Xp: Data_batch, Yp: Label_batch,train_mode:False})
    ...
    if (iter+1)%2000==0:
        path = saver.save(sess,'UpscaleSRGAN_session/SRGAN_MSE_imagenet_SMD255.ckpt')
        print(path)